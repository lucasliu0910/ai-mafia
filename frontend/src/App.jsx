...
function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-slate-900 text-slate-100 p-4">
      ...
      <div className="relative z-10 w-full max-w-md px-8 py-10 bg-slate-800/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-slate-700/50">
        {!joined ? (
          ...
          <div className="text-center p-8">
            ...
            <p className="text-slate-400 animate-pulse">Entering chat phase... (WIP)</p>
          </div>
        ) : null}
      </div>
    </div>
